		...
		<div class="main">
			...
			<table>
				<tr id="cardSelect">
					<th>カードを選択</th>
					<td>
						<!-- カードの種類を選択 --> <select name="card" required>
							<option value=""></option>
				...
				<tr>
					...
					<td><input type="text" name="cardHolder" size="30"
						...
						title="大文字アルファベット20文字以内で入力してください。" placeholder="名前を入力してください"
						required /></td>
				</tr>
				<tr>
					<th>カード番号</th>
					<!-- カード番号を入力 -->
					<td><input type="text" name="cardNumber" size="30"
						pattern="[0-9]{16}" maxlength="16" title="数字のみ16桁を入力してください。"
						placeholder="カード番号を入力してください" required /></td>
				</tr>
				<tr>
					<th>有効期限</th>
					<!-- 有効期限を選択 -->
					...
					</select> <select name="cardYear" required>
							<option value=""></option>
				...
				<tr>
					<th>セキュリティコード</th>
					<!-- セキュリティコード入力 -->
					<td><input type="password" name="securityCode" size="30"
						maxlength="4" pattern="[0-9]{3,4}" title="数字のみ3桁または4桁を入力してください。"
						placeholder="セキュリティコードを入力してください" required /></td>
				</tr>
			</table>
		</div>
		<p align="center" class="pinput">
			<input type="submit" name="ReservationCmpBtn" value="決済内容確認画面へ"
				class="ReservationCmpBtn" />
		</p>
	</form>
	<script>
