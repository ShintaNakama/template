...
<body style="text-align: center;">
	...
	<input type=hidden name="reservationLoginUser"
		...
		<input type=hidden name="reservationDate"
			...
			value="<s:property value="reservationStart"/>"> <input
			type=hidden name="reservationEnd"
			value="<s:property value="reservationEnd"/>"> <input
			type=hidden name="reservationName"
			value="<s:property value="reservationName"/>"> <input
			type=hidden name="pay" value="<s:property value="pay"/>">
